...
class Config {
    ...
    const SANDBOX_EMAIL = "seuemail@seuemail";
    const PRODUCTION_EMAIL = "seuemail@seuemail";

    const SANDBOX_TOKEN = "token_sandbox";
    const PRODUCTION_TOKEN = "token_produção";
    ...
    const NOTIFICATION_URL = "https://sualoja.com.br/payment/notification";
